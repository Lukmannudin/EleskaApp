...
//
//        val group1: FloatArray = floatArrayOf(10f)
//        val group2: FloatArray = floatArrayOf(30f)
//
...
//
//        for (i in 0..3) {
//            entriesGroup1.add(BarEntry(i.toFloat(), group1))
//            entriesGroup2.add(BarEntry(i.toFloat(), group2))
//        }
//
//        val set1 = BarDataSet(entriesGroup1, "Group 1")
//        val set2 = BarDataSet(entriesGroup2, "Group 2")
//
...
//        chart?.invalidate()
    ...
    override fun onProgressChanged(
        ...
        tvX?.text = java.lang.String.format(Locale.ENGLISH, "%d-%d", startYear, endYear)
        ...
        chart!!.xAxis.axisMaximum = startYear + chart!!.barData.getGroupWidth(
            groupSpace,
            barSpace
        ) * groupCount
